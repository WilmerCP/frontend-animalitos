...
function BetLedger({ bets = [], roundNumber, winningId, onToggle, isOpen }) {
  ...
  return (
    <div className={` h-screen sticky top-0 bg-zinc-200 text-card-foreground flex flex-col transition-all duration-300 ${isOpen ? "translate-x-0 w-1/5" : "translate-x-full w-0"} `}>
