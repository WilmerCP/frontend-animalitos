      ...
      <Section title="Preguntas Frecuentes">
        <div className="space-y-2">
          <FAQItem
            ...
            a="Si, puedes distribuir tus apuestas en varios animales"
          />
          <FAQItem
          ...
          <FAQItem
            ...
            a="El contrato requiere tener permiso para poder hacer la transferencia de tokens, aprobar un monto mayor es seguro, permite hacer apuestas mas rápido en el futuro"
          />
          <FAQItem
